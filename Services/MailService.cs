...
namespace ProjectManager.Services
{
    public class MailService : IMailService
    {
        ...
        public void SendAssignedManagerEmail(string manageremail, string managername, string generatorname, int id)
        {
            MailMessage msg = new MailMessage();
            SmtpClient client = new SmtpClient("smtp-mail.outlook.com");
        ...
        public void SendNewTaskEmail(string email, string generatoremail, int id, string responsiblename, string generatorname, string targetdate)
        {
            MailMessage msg = new MailMessage();
            SmtpClient client = new SmtpClient("smtp-mail.outlook.com");
